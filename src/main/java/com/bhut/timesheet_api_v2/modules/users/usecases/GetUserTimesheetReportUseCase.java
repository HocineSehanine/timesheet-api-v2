...
@Service
public class GetUserTimesheetReportUseCase {

    private final ReleasesRepository releasesRepository;
    private final HolidayRepository holidayRepository;

    GetUserTimesheetReportUseCase(final ReleasesRepository releasesRepository, final HolidayRepository holidayRepository) {
